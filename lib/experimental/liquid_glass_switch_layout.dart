...
/// Sizing for [LiquidGlassSwitchExperimental] — the track behind the
/// thumb and the two sizes the thumb itself morphs between.
///
...
class LiquidGlassSwitchLayout {
  ...
  double get padY =>
      math.max(0.0, (expandedThumbHeight - height) / 2) + 4.0;
